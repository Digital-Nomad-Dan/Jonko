...
(function(e) {
    ...
    var t = "Close", n = "BeforeClose", r = "AfterClose", i = "BeforeAppend", s = "MarkupParse", o = "Open", u = "Change", a = "mfp", f = "." + a, l = "mfp-ready", c = "mfp-removing", h = "mfp-prevent-close", p, d = function() {}, v = !!window.jQuery, m, g = e(window), y, b, w, E, S = function(e, t) {
        p.ev.on(a + e + f, t)
    }, x = function(t, n, r, i) {
        var s = document.createElement("div");
        return s.className = "mfp-" + t,
        r && (s.innerHTML = r),
        i ? n && n.appendChild(s) : (s = e(s),
        n && s.appendTo(n)),
        s
    }, T = function(t, n) {
        p.ev.triggerHandler(a + t, n),
        p.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1),
        p.st.callbacks[t] && p.st.callbacks[t].apply(p, e.isArray(n) ? n : [n]))
    }, N = function(t) {
        if (t !== E || !p.currTemplate.closeBtn)
            p.currTemplate.closeBtn = e(p.st.closeMarkup.replace("%title%", p.st.tClose)),
            E = t;
        return p.currTemplate.closeBtn
    }, C = function() {
        e.magnificPopup.instance || (p = new d,
        p.init(),
    ...
    d.prototype = {
        ...
        open: function(t) {
            ...
            p.types = [],
            w = "",
            t.mainEl && t.mainEl.length ? p.ev = t.mainEl.eq(0) : p.ev = y,
            t.key ? (p.popupsCache[t.key] || (p.popupsCache[t.key] = {}),
            p.currTemplate = p.popupsCache[t.key]) : p.currTemplate = {},
            p.st = e.extend(!0, {}, e.magnificPopup.defaults, t),
            ...
            p.bgOverlay || (p.bgOverlay = x("bg").on("click" + f, function() {
                p.close()
            }),
            p.wrap = x("wrap").attr("tabindex", -1).on("click" + f, function(e) {
            ...
            T("BeforeOpen"),
            p.st.showCloseBtn && (p.st.closeBtnInside ? (S(s, function(e, t, n, r) {
                n.close_replaceWith = N(r.type)
            }),
            w += " mfp-close-btn-in") : p.wrap.append(N())),
            p.st.alignTop && (w += " mfp-align-top"),
            ...
            p.st.enableEscapeKey && y.on("keyup" + f, function(e) {
                e.keyCode === 27 && p.close()
            }),
            g.on("resize" + f, function() {
                p.updateSize()
            }),
            p.st.closeOnContentClick || (w += " mfp-auto-cursor"),
            w && p.wrap.addClass(w);
            var c = p.wH = g.height()
              , h = {};
            ...
            setTimeout(function() {
                p.content ? (p._addClassToMFP(l),
                p._setFocus()) : p.bgOverlay.addClass(l),
                y.on("focusin" + f, p._onFocusIn)
            }, 16),
            p.isOpen = !0,
            p.updateSize(c),
            T(o),
        ...
        close: function() {
            ...
            T(n),
            p.isOpen = !1,
            p.st.removalDelay && !p.isLowIE && p.supportsTransition ? (p._addClassToMFP(c),
            setTimeout(function() {
                p._close()
        ...
        updateItemHTML: function() {
            ...
            var n = t.type;
            T("BeforeChange", [p.currItem ? p.currItem.type : "", n]),
            p.currItem = t;
            if (!p.currTemplate[n]) {
        ...
        appendContent: function(e, t) {
            p.content = e,
            e ? p.st.showCloseBtn && p.st.closeBtnInside && p.currTemplate[t] === !0 ? p.content.find(".mfp-close").length || p.content.append(N()) : p.content = e : p.content = "",
            T(i),
        ...
        addGroup: function(e, t) {
            ...
            t.mainEl = e,
            t.items ? (t.isObj = !0,
            e.off(r).on(r, n)) : (t.isObj = !1,
            t.delegate ? e.off(r).on(r, t.delegate, n) : (t.items = e,
            e.off(r).on(r, n)))
        },
        ...
        _checkIfClose: function(t) {
            ...
            if (t !== p.content[0] && !e.contains(p.content[0], t)) {
                if (e(t).closest(".mfp-arrow").hasClass("mfp-prevent-close"))
                    return;
                if (r && e.contains(document, t))
                    return !0
            } else if (n)
                return !0;
            return !1
    ...
    e.fn.magnificPopup = function(t) {
        ...
        if (typeof t == "string")
            if (t === "open") {
                ...
                i.items ? r = i.items[s] : (r = n,
                i.delegate && (r = r.find(i.delegate)),
                r = r.eq(s)),
                p._openClick({
                    mfpEl: r
                }, n, i)
    ...
    ;
    var L = "inline", A, O, M, _ = function() {
        M && (O.after(M.addClass(A)).detach(),
        M = null)
    };
            ...
            getInline: function(t, n) {
                ...
                if (t.src) {
                    ...
                    if (i.length) {
                        ...
                        s && s.tagName && (O || (A = r.hiddenClass,
                        O = x(A),
                        A = "mfp-" + A),
                        M = i.after(O).detach().removeClass(A)),
    ...
    var j, F = function(t) {
        if (t.data && t.data.title !== undefined)
            return t.data.title;
    ...
    e.magnificPopup.registerModule("image", {
        options: {
            markup: '<div class="mfp-figure"><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div><div class="mfp-close"></div><figure><div class="mfp-img"></div></figure></div>',
        ...
        proto: {
            initImage: function() {
                ...
                p.types.push("image"),
                S(o + r, function() {
                    p.currItem.type === "image" && n.cursor && e(document.body).addClass(n.cursor)
                }),
                S(t + r, function() {
                    n.cursor && e(document.body).removeClass(n.cursor),
                    g.off("resize" + f)
                }),
                S("Resize" + r, p.resizeImage),
                p.isLowIE && S("AfterChange", p.resizeImage)
            },
            ...
            getImage: function(t, n) {
                var r = 0
                  , i = function() {
                    ...
                    t === p.currItem && (p._onImageHasSize(t),
                    p.updateStatus("ready")),
                    t.hasSize = !0,
                    t.loaded = !0,
                    T("ImageLoadComplete")) : (r++,
                    r < 200 ? setTimeout(i, 100) : s()))
                }
                  , s = function() {
                ...
                t.loadError ? (n.addClass("mfp-loading"),
                p.updateStatus("error", o.tError.replace("%url%", t.src))) : (n.removeClass("mfp-loading"),
                p.updateStatus("ready")),
                n) : (p.updateStatus("loading"),
                t.loading = !0,
    ...
    var I, q = function() {
        return I === undefined && (I = document.createElement("p").style.MozTransform !== undefined),
        I
    };
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(t) {
                ...
                return q() ? o["-moz-transform"] = o.transform = "translate(" + r.left + "px," + r.top + "px)" : (o.left = r.left,
                o.top = r.top),
                o
            }
        }
            ...
            getIframe: function(t, n) {
                ...
                e.each(i.patterns, function() {
                    if (r.indexOf(this.index) > -1)
                        return this.id && (typeof this.id == "string" ? r = r.substr(r.lastIndexOf(this.id) + this.id.length, r.length) : r = this.id.call(this, r)),
        ...
        proto: {
            initGallery: function() {
                ...
                S(o + r, function() {
                    ...
                    y.on("keydown" + r, function(e) {
                        e.keyCode === 37 ? p.prev() : e.keyCode === 39 && p.next()
                    })
                }),
                S("UpdateStatus" + r, function(e, t) {
                    t.text && (t.text = X(t.text, p.currItem.index, p.items.length))
                }),
                S(s + r, function(e, t, r, i) {
            ...
            _preloadItem: function(t) {
                ...
                T("LazyLoad", n),
                n.type === "image" && (n.img = e('<img class="mfp-img" />').on("load.mfploader", function() {
                    n.hasSize = !0
            ...
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = p.st.retina
                      , t = e.ratio;
                    t = isNaN(t) ? t() : t,
                    t > 1 && (S("ImageHasSize." + V, function(e, n) {
                        n.img.css({
                            "max-width": n.img[0].naturalWidth / t,
                            width: "100%"
                        })
                    }),
                    S("ElementParse." + V, function(n, r) {
...
function(e, t) {
    ...
    n = function(n, r) {
        ...
        var u = function() {
            return o = i._findMultiplier(),
            i.$el.on("click", i.options.elements.nav + " a", function(e) {
                e.preventDefault(),
                i.stop(),
                t(this).hasClass("next") ? i.animate("next", function() {
                    i.start()
            ...
            t(document).on("keyup", function(e) {
                e.keyCode === 37 && i.animate("prev"),
                e.keyCode === 39 && i.animate("next")
            }),
          ...
          , a = {
            containers: function() {
                ...
                i.size() === 1 && i.$el.find(i.options.elements.nav).hide()
            },
            images: function() {
          ...
          , c = {
            ...
            _events: function() {
                i.$el.on("click", i.options.elements.pagination + " a", function(e) {
                    e.preventDefault();
                    var t = i._parseHash(this.hash), n;
                    n = i._upcomingSlide(t, !0),
                    n !== i.current && i.animate(n, function() {
                        i.start()
                    })
                })
            }
    ...
    n.prototype = {
        ...
        start: function() {
            var n = this;
            n.options.hashchange ? t(e).trigger("hashchange") : this.animate(),
        ...
        animate: function(t, n) {
            ...
            r.animation(i, function() {
                ...
                r.init || (r.$el.trigger("init.slides"),
                r.init = !0,
...
function() {
    ...
    s.prototype.refresh = function() {
        var e = this.element == this.element.window, t = e ? undefined : this.adapter.offset(), n = {}, i;
        this.handleScroll(),
        i = {
            horizontal: {
        ...
        for (var s in i) {
            ...
            for (var u in this.waypoints[s]) {
                var a = this.waypoints[s][u], f = a.options.offset, l = a.triggerPoint, c = 0, h = l == null, p, d, v, m, g;
                a.element !== a.element.window && (c = a.adapter.offset()[o.offsetProp]),
                typeof f == "function" ? f = f.apply(a) : typeof f == "string" && (f = parseFloat(f),
                a.options.offset.indexOf("%") > -1 && (f = Math.ceil(o.contextDimension * f / 100))),
                p = o.contextScroll - o.contextOffset,
                a.triggerPoint = c + p - f,
                d = l < o.oldScroll,
                v = a.triggerPoint >= o.oldScroll,
                m = d && v,
                g = !d && !v,
                !h && m ? (a.queueTrigger(o.backward),
                n[a.group.id] = a.group) : !h && g ? (a.queueTrigger(o.forward),
                n[a.group.id] = a.group) : h && o.oldScroll >= a.triggerPoint && (a.queueTrigger(o.forward),
    ...
    function t(t) {
        return function() {
            ...
            this.each(function() {
                ...
                typeof i.context == "string" && (i.context = t(this).closest(i.context)[0]),
                n.push(new e(i))
            }),
            n
        }
...
$(document).ready(function() {
    ...
    this.inPreview && setTimeout(function() {
        Waypoint.refreshAll()
    }, 800),
    searchForm = $("form.search"),
    searchForm.length && ($("body").on("click", "a[href=#search]", function(e) {
        e.preventDefault(),
        searchForm.addClass("open"),
        isIE() || searchForm.find("input[type=text]").focus()
    }),
...
$(document).keyup(function(e) {
    e.keyCode == 27 && (searchForm.length && searchForm.removeClass("open"),
    mobileNav.length && mobileNav.removeClass("open"))
});
